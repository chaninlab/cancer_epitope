...
setwd("d:/R_test/undersampling dual_vs_mono_epitopes")

#Change this to the correct input file name
df <- read.csv("dual_vs_mono_epitopes.csv")
...
seed_vec<-c(seed_vec,522)  #,495,123,789,754)
...
write.csv(df, file = paste0("the undersampling balanced class.csv"))
print("balanced class outputted")
